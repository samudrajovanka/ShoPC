...
public class Data {
    ...
    private static final ArrayList<Product> products = new ArrayList<>(Arrays.asList(
            ...
            new OperatingSystem("Windows 10 Pro", 2831290, 5, 82, R.drawable.os_microsoft_windows_10_pro, "v2020", 15000,"qwertyuiop", new Date(2030,5,15), "Microsoft"),
            new Antivirus("Smadav", 43000, 3, 55, R.drawable.av_smadav, "v14.4", 1000, "987654321", new Date(2021,13,12), "Zainuddin Nafarin"),
            new Antivirus("McAfee", 820000, 1, 66, R.drawable.av_mcafee, "v22.1", 1000, "456789123", new Date(2021,13,12), "NitroSecurity"),
            ...
            new OperatingSystem("Windows 10 Home", 1967746, 4, 22, R.drawable.os_windows_10_home, "v2020", 15000, "asdfghjkl", new Date(2030,5,15), "Microsoft"),
            ...
            new Vga("GTX 1080 Ti",11000000, 3, 20, R.drawable.vga_gtx, 200, 100 ,150, 150, "NVIDIA", "1080 Ti", 4, 11),
            ...
            new OperatingSystem("Windows 8 Pro", 1967746, 3, 6, R.drawable.os_microsoft_windows_8, "v8.1", 6000, "zxcvbnm", new Date(2030,5,15), "Microsoft"),
            new Antivirus("Kaspersky Anti-virus", 308000, 4, 55, R.drawable.av_kaspersky, "v10.15", 1000, "123456789", new Date(2021,13,12), "Kaspersky"),
