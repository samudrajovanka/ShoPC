...
public class ProfileFragment extends Fragment implements View.OnClickListener{
    ...
    private void initiateUi(View view) {
        ...
        ConstraintLayout containerBtnEditProfile = view.findViewById(R.id.container_btn_edit_profile);
        ConstraintLayout containerBtnDeleteAccount = view.findViewById(R.id.container_btn_delete_account);
    ...
    public void onClick(View view) {
        switch(view.getId()) {
            case R.id.container_btn_add_saldo:
                Toast.makeText(getActivity(), "Btn Add Saldo bisa", Toast.LENGTH_SHORT).show();
                break;
            ...
            case R.id.container_btn_delete_account:
                Toast.makeText(getActivity(), R.string.delete_account_success, Toast.LENGTH_SHORT).show();
